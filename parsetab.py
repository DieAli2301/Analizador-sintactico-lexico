...
_lr_productions = [
  ...
  ('program -> declarations statements','program',2,'p_program','parser_1.py',10),
  ('declarations -> declarations declaration','declarations',2,'p_declarations','parser_1.py',15),
  ('declarations -> declaration','declarations',1,'p_declarations','parser_1.py',16),
  ('declaration -> INT ID ASSIGN NUMBER SEMICOLON','declaration',5,'p_declaration','parser_1.py',19),
  ('declaration -> FLOAT ID ASSIGN FLOAT_LITERAL SEMICOLON','declaration',5,'p_declaration','parser_1.py',20),
  ('declaration -> STRING ID ASSIGN STRING_LITERAL SEMICOLON','declaration',5,'p_declaration','parser_1.py',21),
  ('statements -> statements statement','statements',2,'p_statements','parser_1.py',26),
  ('statements -> statement','statements',1,'p_statements','parser_1.py',27),
  ('statement -> if_statement','statement',1,'p_statement','parser_1.py',30),
  ('statement -> while_statement','statement',1,'p_statement','parser_1.py',31),
  ('statement -> for_statement','statement',1,'p_statement','parser_1.py',32),
  ('statement -> input_statement','statement',1,'p_statement','parser_1.py',33),
  ('statement -> increment_statement','statement',1,'p_statement','parser_1.py',34),
  ('statement -> assignment_statement','statement',1,'p_statement','parser_1.py',35),
  ('if_statement -> IF LPAREN condition RPAREN LBRACE statements RBRACE','if_statement',7,'p_if_statement','parser_1.py',38),
  ('condition -> expression AND expression','condition',3,'p_condition','parser_1.py',41),
  ('condition -> expression','condition',1,'p_condition','parser_1.py',42),
  ('expression -> simple_expression comparison_operator simple_expression','expression',3,'p_expression','parser_1.py',46),
  ('expression -> simple_expression','expression',1,'p_expression','parser_1.py',47),
  ('simple_expression -> ID','simple_expression',1,'p_simple_expression','parser_1.py',54),
  ('simple_expression -> NUMBER','simple_expression',1,'p_simple_expression','parser_1.py',55),
  ('simple_expression -> FLOAT_LITERAL','simple_expression',1,'p_simple_expression','parser_1.py',56),
  ('simple_expression -> STRING_LITERAL','simple_expression',1,'p_simple_expression','parser_1.py',57),
  ('comparison_operator -> EQ','comparison_operator',1,'p_comparison_operator','parser_1.py',63),
  ('comparison_operator -> GT','comparison_operator',1,'p_comparison_operator','parser_1.py',64),
  ('comparison_operator -> GE','comparison_operator',1,'p_comparison_operator','parser_1.py',65),
  ('comparison_operator -> LT','comparison_operator',1,'p_comparison_operator','parser_1.py',66),
  ('comparison_operator -> LE','comparison_operator',1,'p_comparison_operator','parser_1.py',67),
  ('comparison_operator -> NE','comparison_operator',1,'p_comparison_operator','parser_1.py',68),
  ('while_statement -> WHILE LPAREN condition RPAREN LBRACE statements RBRACE','while_statement',7,'p_while_statement','parser_1.py',72),
  ('for_statement -> FOR LPAREN ID IN RANGE LPAREN NUMBER COMMA NUMBER RPAREN RPAREN LBRACE statements RBRACE','for_statement',14,'p_for_statement','parser_1.py',75),
  ('input_statement -> INPUT LPAREN simple_expression RPAREN SEMICOLON','input_statement',5,'p_input_statement','parser_1.py',81),
  ('increment_statement -> ID PLUS PLUS SEMICOLON','increment_statement',4,'p_increment_statement','parser_1.py',86),
  ('assignment_statement -> ID ASSIGN expression SEMICOLON','assignment_statement',4,'p_assignment_statement','parser_1.py',90),
]
